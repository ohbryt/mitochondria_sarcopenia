...
> **Version note (v0.3):** Adds the rigorous, correlation-aware **label-permutation
...
is the signature of a coordinated collapse of the mitochondrial **biogenesis**
...
the exploratory gate. Ranking all 37,469 genes by their random-effects meta-z, the
nuclear-encoded mitochondrial gene programme (539 genes) is shifted strongly toward
down-regulation (competitive shift in mean meta-z of −1.14 relative to the rest of
the genome; Figure 5).
...
the entire per-gene meta statistic, and rebuild the gene-set statistic 2,000 times
(`scripts/pathway_permutation.py`). This is a genuinely correlation-aware test (the
permutation equivalent of CAMERA's variance inflation).
...
cristae/MICOS (5.0×10⁻⁴), and protein import (3.0×10⁻³). This is the signature of a
coordinated collapse of the mitochondrial **biogenesis** programme (translation,
import, cristae assembly, and the respiratory chain) rather than isolated loss of
...
modules together is the signature of a **mitochondrial biogenesis-programme collapse**,
...
---
*Manuscript version: v0.3 — 2026-06-11. Adds correlation-aware label-permutation gene-set test (N=2,000) and mitochondrial sub-programme decomposition (Figure 5); carries forward v0.2 corrections (OXPHOS→mitochondrial, post-hoc gate, two-study framing, composition-robustness). See `CRITICAL_REVIEW_v0.1.md` / `CRITICAL_REVIEW_v0.2.md`.*
